...
from my_package.utils import COLOR_OK, COLOR_NOK, COLOR_BORDER, COLOR_TEXT, GREEN, YELLOW, WHITE, NC, CHECK, show_banner as utils_show_banner
...
class gestion_pass:
    ...
    def menu_pass(self):
        while True:
            ...
            elif choix == "Désactivation Mot de Passe":
                pass     

            elif choix == "Durée de mise en cache de la passphrase":
                pass

            elif choix == "Réactiver une clé expirée":
                pass

            elif choix == "Supprimer clé":
                from my_package.Gestion.Key.delete_key import erase   
                erase()
